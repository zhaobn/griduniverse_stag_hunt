...
def deploy_sandbox_shared_setup(
    ...
    log("Should have printed deployment")
    #Line Edited
    with open('/home/undrill/Desktop/Griduniverse/demos/heroku_apps.txt', 'a') as file:
        file.write(str(heroku_app.name))
        file.write("\n")
    
    log("Should have wrote to heroku_apps")
    ...
    #Line Edited - Print Recruitment Message
    filename_savelink = "/home/undrill/Desktop/Griduniverse/demos/save_links.txt"
    with open(filename_savelink, 'a') as file:
        file.write(result["recruitment_msg"] + "\n")
